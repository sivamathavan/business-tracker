...
export const RePropertiesTab: React.FC<Props> = ({ properties, onSave, onDelete, onActivity }) => {
  ...
  const re_exportCSV = () => {
    ...
    exportToCSV(data, 'dkproperties_properties');
  };
  ...
  const re_exportPDF = () => {
    ...
    exportToPDF('DkProperties — Properties', headers, rows, 'dkproperties_properties', [255, 107, 107]);
  };
