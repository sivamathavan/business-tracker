...
async function main() {
  ...
  const reBiz = await prisma.business.create({
    data: { name: 'DkProperties', slug: 'realestate' }
  });
  ...
  const coachingBiz = await prisma.business.create({
    data: { name: 'AchieversNest', slug: 'coaching' }
  });
  ...
  console.log('Seeding AchieversNest Data...');
