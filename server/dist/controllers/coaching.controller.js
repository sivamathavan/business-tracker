...
const createCoachingStudent = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'CREATE', `Coaching Student: ${student_name}`);
...
const updateCoachingStudent = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'UPDATE', `Coaching Student: ${updated.student_name}`);
...
const deleteCoachingStudent = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'DELETE', `Coaching Student: ${student.student_name}`);
...
const upsertFeeRecord = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'UPDATE', `Fee Paid: ${student?.student_name} for ${month_year}`);
...
const createExam = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'CREATE', `Exam Template: ${exam_name} for ${standard}`);
...
const saveBulkExamResults = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'UPDATE', `Exam scores saved for: ${exam.exam_name} (${exam.standard})`);
...
const createCoachingStaff = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'CREATE', `Staff: ${staff_name}`);
...
const updateCoachingStaff = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'UPDATE', `Staff: ${updated.staff_name}`);
        return res.status(200).json({ success: true, data: updated });
    }
    catch (error) {
        next(error);
...
const deleteCoachingStaff = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'DELETE', `Staff: ${staff.staff_name}`);
...
const createCoachingBatch = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'CREATE', `Coaching Batch: ${batch_name}`);
...
const updateCoachingBatch = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'UPDATE', `Coaching Batch: ${updated.batch_name}`);
        return res.status(200).json({ success: true, data: updated });
    }
    catch (error) {
        next(error);
...
const deleteCoachingBatch = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'DELETE', `Coaching Batch: ${batch.batch_name}`);
...
const autoGenerateMonthlyFees = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)('system_auto', 'AchieversNest', 'CREATE', `Auto-generated ${generatedCount} fee records for ${currentMonthYear}`);
...
const markCoachingAttendance = async (req, res, next) => {
    try {
        ...
        await (0, activityLogger_1.logActivity)(req.user?.userId || 'system', 'AchieversNest', 'UPDATE', `Marked attendance for ${date}`);
